...
async def funzioneafk(client, message):
   ...
   if afk == True and not message.chat.id in approve:
      ...
      # Messaggio AFK senza forward specifico
      pass
...
@Client.on_message(filters.user("self") & filters.command("test","."))
async def test_command(client, message):
    await message.edit("✅ **Bot funzionante!** I comandi stanno funzionando correttamente.")
...
@Client.on_message(filters.user("self") & filters.command("cmd", "."))
